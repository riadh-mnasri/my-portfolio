  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse 50% 60% at 30% 50%, rgba(212,175,55,0.1) 0%, transparent 70%)",
      }} />
      {/* Glow right */}
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse 40% 50% at 75% 50%, rgba(212,175,55,0.06) 0%, transparent 70%)",
      }} />
            ...
            >
              ...
              <div className="relative w-64 h-64 md:w-72 md:h-72">
                <motion.div
                  ...
                  style={{
                    background: "conic-gradient(from 0deg, #D4AF37 0%, rgba(212,175,55,0.25) 50%, #D4AF37 100%)",
                  }}
                />
