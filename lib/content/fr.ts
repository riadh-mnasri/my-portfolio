...
export const fr: PortfolioContent = {
  ...
  projects: {
    ...
    followersLabel: "7 766 abonnés",
    reactionsLabel: "réactions",
    githubTitle: "GitHub Open Source",
    reposLabel: "155 repos",
    catalogLinkLabel: "Voir toutes mes apps →",
    ...
    items: [
      ...
      {
        title: "aceready",
        desc: "Prépa entretien technique Java, Spring, Kotlin, Kafka, Cloud et IA : questions, corrections et suivi de progression",
        tags: ["Java", "Cloud", "Interview"],
        url: "https://github.com/riadh-mnasri/aceready",
      },
      {
        title: "ffe-mcp",
        desc: "Serveur MCP pour interroger les données publiques de la Fédération Française des Échecs depuis Claude",
        tags: ["MCP", "TypeScript", "Échecs"],
        url: "https://github.com/riadh-mnasri/ffe-mcp",
      },
      {
        title: "ecoledirecte-mcp",
        desc: "Serveur MCP pour interroger un compte EcoleDirecte (notes, devoirs, absences) depuis Claude, en local",
        tags: ["MCP", "TypeScript", "AI"],
        url: "https://github.com/riadh-mnasri/ecoledirecte-mcp",
      },
      {
        title: "go-primer",
        desc: "Parcours bilingue FR/EN pour apprendre Go de zéro : syntaxe, flux de contrôle, idiomes, exercices pratiques",
        tags: ["Go", "Pédagogie", "Next.js"],
        url: "https://github.com/riadh-mnasri/go-primer",
      },
      {
        title: "learning-rust",
        desc: "Parcours d'apprentissage Rust du zéro absolu jusqu'à l'async, en 16 exemples testés",
        tags: ["Rust", "Pédagogie", "Async"],
